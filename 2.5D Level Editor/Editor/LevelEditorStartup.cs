...
partial class LevelEditer : GameObjectLibrary
{
    ...
    private Tile LoadTile(int x, int y, string tiletype)
    {
        ...
        {
            case "Tile":
                return new Tile(new Point(x, y), sset, tp, tt);
            case "WallTile":
                return new WallTile(new Point(x, y), sset, tp, tt);
            case "TreeTile":
                return new TreeTile(new Point(x, y), sset, tp, tt);
            case "GrassTile":
                return new GrassTile(new Point(x, y), sset, tp, tt);
        }
